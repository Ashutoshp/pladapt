...
bool PRISMWrapper::runPrism(const char* pctl) {
	//cout << "PRISMWrapper::runPrism" << endl;
...
set<int> PRISMWrapper::getNowStates() {
	 ...
	 * <state>:(<value1>,<value2>,...)
	 */
	//cout << "PRISMWrapper::getNowStates" << endl;
	set<int> states;
...
vector<string> PRISMWrapper::getActions(set<int>& states) {
	...
	//cout << "PRISMWrapper::getActions" << endl;
...
bool PRISMWrapper::generateModel(string environmentModel, string initialState, const char* modelPath) {
	//cout << "PRISMWrapper::generateModel" << endl;
...
void PRISMWrapper::generatePersistentPlan(const std::string& environmentModel, const std::string& initialState,
	...
	//cout << "PRISMWrapper::generatePersistentPlan" << endl;
	// create temp directory
	char tempDirTemplate[] = "modelXXXXXX";
	tempDir = mkdtemp(tempDirTemplate);
	if (!tempDir) {
...
/*void PRISMWrapper::closeModel(){
	cout << "PRISMWrapper::closeModel" << endl;
...
string PRISMWrapper::getModelDirectory(){
	//cout << "PRISMWrapper::getModelDirectory" << endl;
