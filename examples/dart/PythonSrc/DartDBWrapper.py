...
from DartProblemDB import *

class DBWrapper:
    def __init__(self, data_file, ignore_seeds = []):
        print("ignore_seeds = ", ignore_seeds)
        ...
        self.__ignore_seeds = ignore_seeds
        self.__ignored_seed_problems = ProblemDatabase()
        self.__not_ignored_seed_problems = ProblemDatabase()
    ...
    def get_ignored_seed_problems(self):
        return self.__ignored_seed_problems

    def get_not_ignored_seed_problems(self):
        return self.__not_ignored_seed_problems
    ...
    def read_db(self):
        ...
        for line in db_csvfile:
            ...
            if (int(seed) in self.__ignore_seeds):
                self.__ignored_seed_problems.add_data(problemInstance)
            else:
